...
# Pattern per validare le chiavi (devono contenere almeno un punto o essere chiavi comuni)
VALID_KEY_PATTERN = re.compile(r'^[a-zA-Z][a-zA-Z0-9._-]*$')

# Carica i cataloghi esistenti
...
print('Prime 10 chiavi rilevate:')
for i, key in enumerate(sorted(code_keys)):
    if i >= 10:
        break
    print(f'  {key}')
...
print(f'\nCataloghi caricati: {list(catalogs.keys())}')
...
print('Prime 10 chiavi mancanti:')
