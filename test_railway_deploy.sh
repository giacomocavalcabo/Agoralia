...
echo "✅ Start Command API: ./railway_start.sh (auto-riparante)"
echo "✅ Start Command Worker: ./railway_worker_start.sh (auto-riparante con test DB)"
echo "✅ Healthcheck: /health (non /crm/health)"
echo "✅ Variabili d'ambiente: DATABASE_URL, APP_KMS_KEY, REDIS_URL"
echo "✅ Worker: disabilita HTTP healthcheck (non serve)"
echo "✅ Script auto-riparante: risolve 'Table already exists' con alembic stamp head"
echo "✅ Fix StringDataRightTruncation: alembic_version colonna varchar(255)"
echo "✅ Fix Worker DB: pulisce variabili ambiente e testa connessione DB"
