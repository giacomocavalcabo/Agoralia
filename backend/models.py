...
class Lead(Base):
    ...
    contact_class = Column(SAEnum(ContactClass, name="contactclass", create_type=False), nullable=True)
    relationship_basis = Column(SAEnum(RelationshipBasis, name="relationship_basis_enum", create_type=False), nullable=True)
    opt_in = Column(Boolean, nullable=True)
    national_dnc = Column(SAEnum(NationalDnc, name="national_dnc_enum", create_type=False), nullable=True)
    compliance_category = Column(SAEnum(ComplianceCategory, name="compliance_category_enum", create_type=False), nullable=True)
