        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Gestisci gli import di dati per la Knowledge Base
            </p>
          </div>
        ...
        <Card title="Import Jobs">
          {jobs.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Nessun job di import trovato</p>
              <p className="text-sm text-gray-400 mt-1">Inizia creando il tuo primo import</p>
            </div>
          ) : (
